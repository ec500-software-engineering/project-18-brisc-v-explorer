function init5StageStalledOrBypassedPipelineDiagram(canvas) {
    ...
    canvas.paper.scale(graphScale.x, graphScale.y);
    ...
    // decode regfile
    var decodeRegFileBlockTemplate = getRegfileTemplate(
    ...
    decodeRegFileBlockTemplate.regfile.addTo(graph);
    decodeRegFileBlockTemplate.clockSymbol.addTo(graph);
    ...
    decodeToRegFileLink.addTo(graph);
    // control unit links
